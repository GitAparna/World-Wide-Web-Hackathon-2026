...
with open('environmental-impact.html', 'r', encoding='utf-8') as f:
    content = f.read()
...
new_content = """
                ...
                <a href="index.html"
                    class="inline-flex group flex items-center gap-2 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-all mb-6">
                    <div
                        class="flex items-center justify-center w-8 h-8 rounded-full border border-slate-200 dark:border-slate-700 group-hover:border-primary group-hover:bg-primary/5 transition-all shadow-sm">
                ...
                <div id="tab-content-env" class="space-y-8 animate-in fade-in duration-500">
                    <!-- 4 Metric Cards -->
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div
                            ...
                            <h3 class="text-slate-500 dark:text-slate-400 text-sm font-semibold mb-1 relative z-10">Volume Processed
                                </h3>
                            <div class="flex items-baseline gap-2 relative z-10">
                                <span
                        ...
                        <div
                            ...
                            <h3 class="text-slate-500 dark:text-slate-400 text-sm font-semibold mb-1 relative z-10">Landfill Policy
                            </h3>
                            <div class="flex items-baseline gap-2 relative z-10">
                                <span
                                    class="text-3xl font-black text-slate-900 dark:text-slate-100 tracking-tight leading-none">Zero</span>
                                <span class="text-sm font-bold text-emerald-500">Policy</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="tab-content-fin" class="space-y-8 hidden animate-in fade-in duration-500">
                    <!-- 4 Metric Cards -->
...
# replace everything from <div class="max-w-6xl mx-auto space-y-8"> to the end of main.
mainPattern = re.compile(r'<div class="max-w-6xl mx-auto space-y-8">.*?</main>', re.DOTALL)
new_content_full = new_content + "\n        </main>"
content = mainPattern.sub(new_content_full, content)

with open('environmental-impact.html', 'w', encoding='utf-8') as f:
    f.write(content)
